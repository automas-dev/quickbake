...
class QuickBakeToolPropertyGroup(bpy.types.PropertyGroup):
    ...
    clean_up: bpy.props.BoolProperty(
        name='Clean Up', description='Remove generated nodes after baking', default=True
    )
    ...
    ao_enabled: bpy.props.BoolProperty(
        name='Ao', description='Bake the Ao map', default=False
    )
    ...
    emit_enabled: bpy.props.BoolProperty(
        name='Emit', description='Bake the Emit map', default=False
    )
